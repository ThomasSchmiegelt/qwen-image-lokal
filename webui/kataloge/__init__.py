...
from .anmutung import (
    AXIS_OFF, CAMERAS, DEVICES, LIGHTS, PAINT_TARGET, PAINTS, PALETTEN,
    STYLES, VARIANT_LIGHTS, VIEWS,
)
from .motiv import (
...
__all__ = [
    "ANGLES", "AXIS_OFF", "CAMERAS", "DEVICES", "EFFECTS", "FORMS",
    "GROUP_ACTIONS", "LIGHTS", "MATERIALS", "OBJECT_ANGLES", "OBJECT_SCENES",
