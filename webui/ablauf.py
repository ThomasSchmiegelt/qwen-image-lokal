...
REISE = [
    ...
    {"titel": "Person", "referenz": "start", "vorlage": "behutsam",
     ...
     "fest": True, "zurueck": True, "bausteine": [
        "the person now has long hair tied up in a bun",
        "the person now has a full beard",
...
def bogen(kulisse: str = "auto") -> list[dict]:
    ...
    return [
            {"titel": "Person", "referenz": "start", "vorlage": "behutsam", "fest": True,
         "zurueck": True,
...
def reise(kulisse: str = "auto") -> list[dict]:
